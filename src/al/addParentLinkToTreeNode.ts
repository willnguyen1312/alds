...
export const addParentLinkToTreeNode = (tree: TreeNodeWithParentLink[]): TreeNodeWithParentLink[] => {
...
const dfs = (treeNode?: TreeNodeWithParentLink, parent?: TreeNodeWithParentLink) => {
  if (!treeNode) return;
